    ...
    <div className="grid gap-3 md:grid-cols-3 lg:grid-cols-6">
      <Card className="bg-card border-border transition-all duration-300 animate-fade-in hover:shadow-md">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 pt-3 px-4">
          <CardTitle className="text-[11px] font-black uppercase tracking-widest text-muted-foreground flex items-center gap-1">To-Do <WidgetInfo description={WIDGET_DESCRIPTIONS["overview-todo"]} /></CardTitle>
      ...
      <Card className="bg-card border-border transition-all duration-300 animate-fade-in hover:shadow-md" style={{ animationDelay: '50ms' }}>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 pt-3 px-4">
          <CardTitle className="text-[11px] font-black uppercase tracking-widest text-muted-foreground flex items-center gap-1">In Progress <WidgetInfo description={WIDGET_DESCRIPTIONS["overview-in-progress"]} /></CardTitle>
      ...
      <Card className="bg-card border-border transition-all duration-300 animate-fade-in hover:shadow-md" style={{ animationDelay: '100ms' }}>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 pt-3 px-4">
          <CardTitle className="text-[11px] font-black uppercase tracking-widest text-muted-foreground flex items-center gap-1">Due Today <WidgetInfo description={WIDGET_DESCRIPTIONS["overview-due-today"]} /></CardTitle>
      ...
      <Card className="bg-card border-border transition-all duration-300 animate-fade-in hover:shadow-md" style={{ animationDelay: '150ms' }}>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 pt-3 px-4">
          <CardTitle className="text-[11px] font-black uppercase tracking-widest text-muted-foreground flex items-center gap-1">Habit Goals <WidgetInfo description={WIDGET_DESCRIPTIONS["overview-habit-goals"]} /></CardTitle>
      ...
      <Card className="bg-card border-border transition-all duration-300 animate-fade-in hover:shadow-md" style={{ animationDelay: '200ms' }}>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 pt-3 px-4">
          <CardTitle className="text-[11px] font-black uppercase tracking-widest text-muted-foreground flex items-center gap-1">Longevity <WidgetInfo description={WIDGET_DESCRIPTIONS["overview-longevity"]} /></CardTitle>
      ...
      <Card className="bg-card border-border transition-all duration-300 animate-fade-in hover:shadow-md" style={{ animationDelay: '250ms' }}>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 pt-3 px-4">
          <CardTitle className="text-[11px] font-black uppercase tracking-widest text-muted-foreground flex items-center gap-1">Avoided <WidgetInfo description={WIDGET_DESCRIPTIONS["overview-avoided"]} /></CardTitle>

...
import { InstantiateTemplateDialog } from "@/components/instantiate-template-dialog";
import {
    AlertDialog,
    AlertDialogAction,
    AlertDialogCancel,
                    ...
                    <div className="md:col-span-3 h-full">
                                    ...
                                    <CardHeader>
                                        <div className="flex justify-between items-start">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <Button onClick={() => setInstantiateDialogOpen(true)} variant="secondary" className="mr-2">
                                                    <Rocket className="h-4 w-4 mr-2" /> Quick Generate
                                                </Button>
                                                <Dialog>
                                                    <DialogTrigger asChild>
                        ...
                        {selectedTemplate && (
                            <InstantiateTemplateDialog
                                template={selectedTemplate}
                                isOpen={instantiateDialogOpen}
                                onOpenChange={setInstantiateDialogOpen}
                                onInstantiate={handleBulkInstantiate}
                            />
                        )}
                    </div>
